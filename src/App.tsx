        ...
        <section
          ...
          <div className="w-full lg:p-12 p-8 border border-muted-white/10 ">
            ...
            <div className="min-h-[250px] flex flex-col lg:justify-end gap-4">
              ...
              <a href="/CV.pdf" download className="w-fit px-4 sm:px-6 lg:px-8 py-3 sm:py-4 text-center flex flex-row items-center gap-1 text-sm sm:text-base bg-muted-white text-dark hover:text-dark/90 hover:bg-white font-medium font-montserrat">
